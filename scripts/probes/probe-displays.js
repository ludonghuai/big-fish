'use strict';
/**
 * probe-displays.js — E6 判定探针：setSize / getSize / getPosition 在 DIP 还是物理像素（B15；设计档 docs/design/PET-MULTIMONITOR.md §2.2）。
 * Purpose: settle the E6 question — are setSize/getSize/getPosition in DIP or physical pixels?
 * 跑法：npx electron scripts/probes/probe-displays.js
 */
