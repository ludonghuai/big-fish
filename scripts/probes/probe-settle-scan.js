'use strict';
/**
 * probe-settle-scan.js — 逐字复现落点校正数学（petSettlePos），主屏逐高度扫描「在哪被弹 / 弹到哪」（B15；设计档 docs/design/PET-MULTIMONITOR.md §2.5）。
 ...
 * 跑法：npx electron scripts/probes/probe-settle-scan.js
 */
