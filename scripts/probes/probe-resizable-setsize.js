'use strict';
/**
 * probe-resizable-setsize.js — `resizable: false` 是否阻断 setSize（B15；设计档 docs/design/PET-MULTIMONITOR.md §2.2）。
 ...
 * 跑法：npx electron scripts/probes/probe-resizable-setsize.js
 */
