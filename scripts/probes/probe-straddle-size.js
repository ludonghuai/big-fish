'use strict';
/**
 * probe-straddle-size.js — 骑线（跨异 DPI 屏边界）时 setSize(250,270) 是否可靠（B15；设计档 docs/design/PET-MULTIMONITOR.md §2.2）。
 ...
 * 跑法：npx electron scripts/probes/probe-straddle-size.js
 */
