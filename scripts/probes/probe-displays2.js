'use strict';
/**
 * probe-displays2.js — 尺寸坐标系机制钉死探针：建窗于各屏 / 跨屏等待 DPI 稳定后的 getSize() 读数（B15；设计档 docs/design/PET-MULTIMONITOR.md §2.2）。
 ...
 * 跑法：npx electron scripts/probes/probe-displays2.js
 */
